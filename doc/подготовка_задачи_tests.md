...
[`standard_checker`](serve.cfg/problem/standard_checker.md)` = "`[`cmp_int`](checker/cmp_int.md)`" # Проверка - сравнение двух целых чисел`  
...
[`standard_checker`](serve.cfg/problem/standard_checker.md)` = "`[`cmp_int`](checker/cmp_int.md)`"`  
...
проверки](verdict/внутренняя_ошибка_проверки.md) выдается в случае
...
ответ](verdict/неправильный_ответ.md). Это не обязательно. Неправильные
