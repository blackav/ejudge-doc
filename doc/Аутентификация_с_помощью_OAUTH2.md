...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[Аутентификация
с помощью OAUTH2](Аутентификация_с_помощью_OAUTH2 "wikilink")
...
#### Регистрация приложения в Yandex ([3.10.0](Изменения_в_версии_3.10.0 "wikilink"))
...
файл [ejudge.xml](ejudge.xml "wikilink") примерно следующим образом:
...
[`enable_oauth`](contest.xml:enable_oauth "wikilink") элемента
[`contest`](contest.xml:contest "wikilink") в файле
[contest.xml](contest.xml "wikilink"). Конфигурационный файл будет
...
[`register_access`](contest.xml:register_access "wikilink"), на турнир
...
помощью элемента [`oauth_rules`](contest.xml:oauth_rules "wikilink").
Например,
...
Начиная с версии [3.13.0](изменения_в_версии_3.13.0 "wikilink")
