...
[`disable_testing`](serve.cfg:problem:disable_testing "wikilink") секции
...
конфигурационного файла [`serve.cfg`](serve.cfg "wikilink") больше
...
задачи [`deadline`](serve.cfg:problem:deadline "wikilink"))
...
переменной [`long_name`](serve.cfg:problem:long_name "wikilink"). Для
...
[`disabled`](serve.cfg:language:disabled "wikilink") секции описания
