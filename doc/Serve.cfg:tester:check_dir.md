...
параметры
тестирования](serve.cfg:tester.md)/[check_dir](Serve.cfg:tester:check_dir.md)
...
[`super`](serve.cfg:tester:super.md), устанавливает данную
...
[`run_check_dir`](serve.cfg:global:run_check_dir.md) следующим
образом:
