...
пользователя](Веб-интерфейс_пользователя.md)/[Элементы просмотра
журнала
...
конфигурации турнира [`serve.cfg`](serve.cfg.md) установлена
глобальная конфигурационная переменная
[`show_astr_time`](serve.cfg:global:show_astr_time.md), в
