...
файлы](Конфигурационные_файлы "wikilink")/[contest.xml](contest.xml "wikilink")/[`enable_avatar`](contest.xml:enable_avatar "wikilink")
...
турнире включается [поддержка аватаров](поддержка_аватаров "wikilink").
