Навигация: [Главная страница](../main_Page.md)/[Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Проверяющие программы](../проверяющие_программы.md)/[Стандартные проверяющие программы](../стандартные_проверяющие_программы.md)/[cmp_long_double_seq](cmp_long_double_seq.md)

Проверяющая программа cmp_long_double_seq сравнивает последовательность
...
Файл результата работы программы должен быть [текстовым файлом](../текстовый_файл.md),
все [элементы ввода](../элемент_ввода.md) в котором являются вещественными
...
программа диагностирует [ошибку неправильного формата результата](../verdict/ошибка_неправильного_формата_результата.md).
...
[внутренюю ошибку проверки](../verdict/внутренняя_ошибка_проверки.md).

Если файл результата работы тестируемой программы и файл эталонного
ответа содержат разное количество чисел, диагностируется [неправильный ответ](../verdict/неправильный_ответ.md).
...
чисел в проверяющей программа
[cmp_long_double](cmp_long_double.md)).
...
(80-битные вещественные значения расширенной точности).
