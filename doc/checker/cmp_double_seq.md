...
Навигация: [Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Проверяющие программы](../проверяющие_программы.md)/[Стандартные проверяющие программы](../стандартные_проверяющие_программы.md)/[cmp_double_seq](cmp_double_seq.md)
...
программа диагностирует
[ошибку неправильного формата результата](../verdict/ошибка_неправильного_формата_результата.md).
...
ответа содержат разное количество чисел, диагностируется
...
Вещественное число должно быть записано по
[правилам записи вещественных чисел](правила_записи_вещественных_чисел.md). Если это условие
