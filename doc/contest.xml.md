...
Навигация: [Система ejudge](система_ejudge.md)/[Использование](использование.md)/[Конфигурационные файлы](конфигурационные_файлы.md)/[contest.xml](contest.xml.md)
...
- [`priv_footer_file`](contest.xml/priv_footer_file.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
- [`priv_header_file`](contest.xml/priv_header_file.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
...
- [`register_footer_file`](contest.xml:register_footer_file.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
- [`register_header_file`](contest.xml/register_header_file.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
- [`register_head_style`](contest.xml/register_head_style.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
- [`register_par_style`](contest.xml/register_par_style.md) (<i>Игнорируется начиная с [версии 3.0](change/изменения_в_версии_3.0.md)</i>)
