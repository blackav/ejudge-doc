...
тестов](Test_checkers.md). Программе проверки тестов передается
...
результата](ошибка_неправильного_формата_результата.md), и
