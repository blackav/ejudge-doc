...
[Предыдущая версия](Изменения_в_версии_3.11.0 "wikilink") [Следующая
версия](Изменения_в_версии_3.13.0 "wikilink")

### Основные улучшения

- Добавлена поддержка языка [PostgresQL](lang:postgres "wikilink").
- [Реализована
  возможность](serve.cfg:problem:enable_src_for_testing "wikilink")
  передать исходный код посылки в проверяющую программу.
- Поддерживаются задачи с [динамической генерацией условий и
  тестов](Динамические_задачи "wikilink").
- Поддерживается эвристическое определение ошибки [Memory-Limit
  Exceeded](Memory-Limit_Exceeded "wikilink").
- Поддерживается [регистрация на
  турнир](Telegram_bot:_регистрация_на_турнир "wikilink") и [получение
  пароля для входа](Telegram_bot:_получение_пароля "wikilink") для уже
...
[Postgres](Lang:postgres "wikilink") (см. [Issue
\#222](https://github.com/blackav/ejudge/issues/222)).

Для языка [Rust](Lang:rust "wikilink") поддерживается сборка с помощью
cargo.
...
программу [ej-super-run](ej-super-run "wikilink").
...
[`enable_telegram_registration`](ejudge.xml:config:enable_telegram_registration "wikilink")
в конфигурационный файл [`ejudge.xml`](ejudge.xml "wikilink") и атрибут
...
Exceeded](Memory-Limit_Exceeded "wikilink") и [Security
Violation](Security_Violation "wikilink").
...
Добавлен конфигурационный параметр языка программирования
[`run_env_file`](serve.cfg:language:run_env_file "wikilink"). Этот
параметр позволяет задать имя файла с переменными окружения, которые
будут переданы в тестируемую программу.

Добавлен конфигурационный параметр языка программирования
[`clean_up_cmd`](serve.cfg:language:clean_up_cmd "wikilink"). Этот
...
данных](Программы_генерации_тестов "wikilink") "на лету".
...
тестовых данных](Программы_генерации_тестов "wikilink") "на лету".

Добавлено эвристическое определение ошибки [Memory-Limit
Exceeded](Memory-Limit_Exceeded "wikilink") при выполнения программ в
контейнере (см. [Issue
...
параметр задачи
[`problem_dir`](serve.cfg:problem:problem_dir "wikilink"). Таким
...
### [cmp_binary](cmp_binary "wikilink")
