Навигация: [Главная страница](../../main_Page.md)/[Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры задач](../problem.md)/[`max_user_run_count`](max_user_run_count.md)
...
статусом [Ignored](../../verdict/ignored.md) не учитываются при подсчете числа
попыток. Попытки со статусом [Compilation Error](../../verdict/compilation_error.md) не учитываются, если установлена
переменная
