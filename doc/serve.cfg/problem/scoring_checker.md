...
Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры задач](../problem.md)/[`scoring_checker`](scoring_checker.md)
...
* 0 &mdash; [`OK`](../../verdict/OK.md)  
* 1 &mdash; [`WA`](../../verdict/WA.md)  
* 2 &mdash; [`PE`](../../verdict/PE.md)  
* 4 &mdash; [`PE`](../../verdict/PE.md)  
* 5 &mdash; [`WA`](../../verdict/WA.md)

все остальные коды интерпретируются как [Check failed](../../verdict/CF.md).
...
- `EJUDGE_MAX_SCORE` устанавливается в максимальный балл за тест ([3.10.0](../../change/изменения_в_версии_3.10.0.md)).
...
- `EJUDGE_TEST_COUNT` — количество тестов в задаче ([3.10.0](../../change/изменения_в_версии_3.10.0.md)).
