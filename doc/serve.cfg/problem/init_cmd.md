...
Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры задач](../problem.md)/[`init_cmd`](init_cmd.md)
...
Данная конфигурационная переменная позволяет задать имя для [программы инициализации](../../программы_инициализации.md).
...
[2.3.22](../../change/изменения_в_версии_2.3.22.md).
