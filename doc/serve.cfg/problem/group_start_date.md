...
Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры задач](../problem.md)/[`group_start_date`](group_start_date.md)

Эта конфигурационная переменная позволяет задавать время, начиная с
которого задача становится доступной для сдачи для определенной
[группы пользователей](группа_пользователей.md). Для каждой группы
