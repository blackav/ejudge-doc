...
Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры задач](../problem.md)/[`vcs_compile_cmd`](vcs_compile_cmd.md)

Данная конфигурационная переменная позволяет задать команду, которая
будет выполняться при компиляции посылки в режиме
[интеграции с системами контроля версий](Интеграция_с_github/gitlab.md).
...
[`lang_compiler_env`](lang_compiler_env.md).
...
компиляции языков программирования. Если настроена
[изоляция недоверенных процессов в контейнерах](../../изоляция_недоверенных_процессов_в_контейнерах.md),
...
склонированный каталог с помощью
[команды постобработки](post_pull_cmd.md). Если команда
