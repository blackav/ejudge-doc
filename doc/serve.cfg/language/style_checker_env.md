...
Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Конфигурационные параметры языков](../language.md)/[`style_checker_env`](style_checker_env.md)

Данная конфигурационная переменная позволяет задавать переменные
окружения, передаваемые
[программе проверки стиля](../../style_checkers.md). Если у соответствующего языка
