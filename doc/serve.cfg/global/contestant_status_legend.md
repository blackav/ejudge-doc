# `contestant_status_legend`

Навигация: [Система ejudge](../../система_ejudge.md)/[Использование](../../использование.md)/[Конфигурационные файлы](../../конфигурационные_файлы.md)/[serve.cfg](../../serve.cfg.md)/[Глобальные конфигурационные параметры](../global.md)/[`contestant_status_legend`](contestant_status_legend.md)
...
[`contestant_status_num`](contestant_status_num.md),
