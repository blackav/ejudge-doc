...
тестов](Задача:tests "wikilink")/[Программа
style_archive](style_archive "wikilink")

Программа style_archive предназначена для проверки правильности
[структуры архива с тестами](структура_архива_с_тестами "wikilink"),
сдаваемого в случае [задач на написание
тестов](Задача:tests "wikilink"). Программа входит в состав системы
...
<tt>[style_checker_env](serve.cfg:problem:style_checker_env "wikilink").
