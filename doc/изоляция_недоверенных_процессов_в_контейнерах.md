...
Навигация: [Система ejudge](система_ejudge.md)/[Использование](использование.md)/[Изоляция недоверенных процессов в контейнерах](изоляция_недоверенных_процессов_в_контейнерах.md)

Изоляция компиляции и выполнения программ в контейнерах доступна с
версии [3.9.0](change/изменения_в_версии_3.9.0.md).
