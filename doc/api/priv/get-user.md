...
ejudge](Система_ejudge.md)/[Использование](Использование.md)/[API](API.md)/[get-user
(привилегированный)](API:priv:get-user.md)
...
([3.11.0](Изменения_в_версии_3.11.0.md)), если он был установлен
при отправке посылки.

Поля `notify_driver`, `notify_kind`, `notify_queue` содержат
[идентификатор очереди
сообщений](Нотификации_во_внешние_системы.md)
([3.11.0](Изменения_в_версии_3.11.0.md)), если он был установлен
при отправке посылки.
