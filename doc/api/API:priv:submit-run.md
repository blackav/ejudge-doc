...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[API](API "wikilink")/[submit-run
(привилегированный)](API:priv:submit-run "wikilink")
...
перетестировании ([3.10.1](Изменения_в_версии_3.10.1 "wikilink")).
...
- `notify_driver`, `notify_kind`, `notify_queue` — [идентификатор
  очереди сообщений](Нотификации_во_внешние_системы "wikilink")
  ([3.11.0](Изменения_в_версии_3.11.0 "wikilink")).
