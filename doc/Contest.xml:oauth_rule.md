...
файлы](Конфигурационные_файлы "wikilink")/[contest.xml](contest.xml "wikilink")/[`oauth_rule`](contest.xml:oauth_rule "wikilink")

|                          |                                                                  |     |
|--------------------------|------------------------------------------------------------------|-----|
| **Имя элемента**:        | **`oauth_rule`**                                                 |     |
| **Содержится в:**        | [`oauth_rules`](contest.xml:oauth_rules "wikilink")              |     |
| **Может содержать:**     | нет                                                              |     |
