...
[`board_fog_time`](serve.cfg:global:board_fog_time.md)) в
конфигурационном файле сервера турнира
[`serve.cfg`](serve.cfg.md). Если значение этой переменной
...
- Нажатие на ссылку “Standings” вызовет переход на страницу отображения
  ...
  [`cap`](contest.xml:cap.md) для него должен быть установлен
  бит `VIEW_STANDINGS`.
...
файле конфигурации турнира [`contest.xml`](contest.xml.md) в
элементе [`cap`](contest.xml:cap.md) должен быть установлен бит
`DUMP_RUNS`.
...
[`contest.xml`](contest.xml.md) в элементе cap должен быть
...
пользователя в файле конфигурации турнира
[`contest.xml`](contest.xml.md) в элементе
[`cap`](contest.xml:cap.md) должен быть установлен бит
`DUMP_STANDINGS`.
