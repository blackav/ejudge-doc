...
программы](Стандартные_проверяющие_программы "wikilink")/[cmp_long_double](cmp_long_double "wikilink")
...
файлом](текстовый_файл "wikilink"). Запись вещественного числа должна
быть единственным [элементом ввода](элемент_ввода "wikilink"), то есть
