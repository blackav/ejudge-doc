...
пользователя](Веб-интерфейс_пользователя "wikilink")/[Конфигурационные
файлы](interface:Конфигурационные_файлы "wikilink")
...
[`serve.cfg`](serve.cfg "wikilink"), он будет использоваться в качестве
конфигурационного.
