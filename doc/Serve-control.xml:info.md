...
файлы](Конфигурационные_файлы "wikilink")/[serve-control.xml](serve-control.xml "wikilink")/[Общая
информация](serve-control.xml:info "wikilink")

Данный конфигурационный файл используется CGI-программой
[`serve-control`](serve-control "wikilink"). Содержимое файла
...
системы с помощью опций скрипта [`configure`](configure "wikilink").
...
`--enable-conf-dir` скрипта [`configure`](configure "wikilink")
