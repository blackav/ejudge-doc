...
Питоне](Доступ_к_ejudge_из_программ_на_Питоне.md)/[Python:
Работа с базой
пользователей](Python:_Работа_с_базой_пользователей.md)/[Python:
Запросы к базе
...
`str = clnt.privListContestUsers(`[`contest_id`](Python:contest_id.md)`)`
...
`str = clnt.privGetContestUsers(`[`contest_id`](Python:contest_id.md)`)`
...
`str = clnt.getUserInfo(`[`contest_id`](Python:contest_id.md)`)`
...
`str = clnt.privGetUserInfo(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
[`user_id`](Python:user_id.md)` = clnt.privCreateUser(`[`login`](Python:login.md)`)`
...
`privDeleteUser(`[`user_id`](Python:user_id.md)`)`
...
`clnt.privEditField(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`serial`](Python:serial.md)`, `[`field_str`](Python:field_str.md)`, `[`value`](Python:value.md)`)`
...
`clnt.privDeleteField(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`serial`](Python:serial.md)`, `[`field_str`](Python:field_str.md)`)`
...
`clnt.privCopyUserInfo(`[`user_id`](Python:user_id.md)`, `[`contest_id_from`](Python:contest_id.md)`, `[`contest_id_to`](Python:contest_id.md)`)`
...
[`serial`](Python:serial.md)` = clnt.privCreateMember(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`role`](Python:role.md)`)`
...
`clnt.privDeleteMember(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`serial`](Python:serial.md)`)`
...
`clnt.privMoveMember(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`serial`](Python:serial.md)`, `[`new_role`](Python:role.md)`)`
...
`clnt.privRegisterContest(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`ip_str`](Python:ip_str.md)`, `[`ssl_flag`](Python:ssl_flag.md)`)`
...
`clnt.privForcedRegisterContest(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privChangeContestReg(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`status_str`](Python:status_str.md)`, `[`cmd_str`](Python:cmd_str.md)`, `[`regflags`](Python:regflags.md)`)`
...
`res = clnt.privLookupUser(`[`login`](Python:login.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`{'user_id':`[`user_id`](Python:user_id.md)`, 'name':`[`name`](Python:name.md)`}`
...
`res = clnt.privLookupUserId(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privSetPassword(`[`user_id`](Python:user_id.md)`, `[`oldpwd`](Python:password.md)`, `[`newpwd`](Python:password.md)`)`
...
`clnt.privSetContestPassword(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`, `[`oldpwd`](Python:password.md)`, `[`newpwd`](Python:password.md)`)`
...
`clnt.privGenerateRandomPassword(`[`user_id`](Python:user_id.md)`)`
...
`clnt.privGenerateRandomContestPassword(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privCopyContestPasswordToPassword(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privCopyPasswordToContestPassword(`[`user_id`](Python:user_id.md)`, `[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privClearContestPasswords(`[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privGenerateRandomContestPasswords(`[`contest_id`](Python:contest_id.md)`)`
...
`clnt.privGenerateRandomPasswords(`[`contest_id`](Python:contest_id.md)`)`
