...
- **Статусный**. Статусный тип имеет имя `result_t` и предназначен для
  ...
  посылок](Вердикты_тестирования.md)).
...
- **`result_t`** к **`int`**. Результатом такого преобразования является
  ...
  [Допустимые статусы посылок](Вердикты_тестирования.md)).
...
- **`result_t`** к **`string`**. Значение статуса преобразовывается в
  ...
  посылок](Вердикты_тестирования.md) (столбец «Выражение
...
- **`int`** к **`result_t`**. Целое значение должно быть равным одному
  ...
  посылок](Вердикты_тестирования.md). В этом случае выполняется
...
- **`string`** к **`result_t`**. Строка должна быть равна одной из
  ...
  посылок](Вердикты_тестирования.md) в столбце «Выражение
...
посылок](Примитивы_доступа_к_базе_посылок.md).
