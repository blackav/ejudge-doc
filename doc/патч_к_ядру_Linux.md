...
работы процесса называется [безопасным](безопасный_режим.md).
...
- [скачивание](Патч_к_ядру_Linux:_скачивание.md)
- [установка](Патч_к_ядру_Linux:_установка.md)
- [использование](Патч_к_ядру_Linux:_использование.md)
