...
языки
программирования](Поддерживаемые_языки_программирования.md)/[`PostgresQL`](Lang:postgres.md)
...
данных](запуск_на_пользовательских_данных.md), так и запуск на
наборе тестов.
...
[`run_env_file`](serve.cfg:language:run_env_file.md)` = "/home/judges/data/postgres.env"`  
[`clean_up_env_file`](serve.cfg:language:clean_up_env_file.md)` = "/home/judges/data/postgres.env"`
...
компонентом компиляции [ej-compile](ej-compile.md).

Параметр [`clean_up_cmd`](serve.cfg:language:clean_up_cmd.md)
задаёт имя программы очистки состояния базы данных после выполнения
запроса.

Параметр [`run_env_file`](serve.cfg:language:run_env_file.md)
