...
конфигурационные
параметры](serve.cfg:global "wikilink")/[`stand_row_attr`](Serve.cfg:global:stand_row_attr "wikilink")
...
[`stand_table_attr`](serve.cfg:global:stand_table_attr "wikilink"), ни
глобальная конфигурационная переменная
[`stand_row_attr`](serve.cfg:global:stand_row_attr "wikilink") не
