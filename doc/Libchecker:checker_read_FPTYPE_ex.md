...
файла](Libchecker:checker_read_FPTYPE_ex "wikilink")

Данные функции позволяют считывать вещественное значение из файла.

`int checker_read_double_ex(FILE *f, `[`checker_error_func_t`](libchecker:checker_error_func_t "wikilink")` error_func,`  
`                          const char *name, int eof_error_flag, double *p_val);`  
`int checker_read_long_double_ex(FILE *f, `[`checker_error_func_t`](libchecker:checker_error_func_t "wikilink")` error_func,`  
