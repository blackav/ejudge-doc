...
Навигация: [Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Общая архитектура системы](../общая_архитектура_системы.md)/[ej-polygon](ej-polygon.md)
...
Для турнира должна быть включена [альтернативная раскладка файлов](../альтернативная_раскладка_файлов.md).
...
проигнорированы. (С версии [3.1.0](../change/изменения_в_версии_3.1.0.md))
