...
Навигация: [Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Общая архитектура системы](../общая_архитектура_системы.md)/[ej-compile](ej-compile.md)
...
| `-k KEY` | Обслуживать только запросы, в которых передается параметр языка программирования [key](../serve.cfg/language/key.md). Позволяет выполнять фильтрацию обрабатываемых запросов по какому-либо типу языков программирования. |
