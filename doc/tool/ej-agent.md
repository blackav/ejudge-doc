Навигация: [Главная страница](../main_Page.md)/[Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Общая архитектура системы](../общая_архитектура_системы.md)/[ej-agent](ej-agent.md)

Этот компонент отвечает за взаимодействие хостов компиляции и выполнения
с сервером ejudge и необходим для организации [компиляции и тестирования, распределенного в сети](../параллельное_тестирование.md).
