Навигация: [Главная страница](../main_Page.md)/[Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Общая архитектура системы](../общая_архитектура_системы.md)/[ej-suid-container](ej-suid-container.md)
...
| `ml`       |                                   | в изолированном пространстве сетевых интерфейсов поднять интерфейс lo (loopback) и настроить его на адрес 127.0.0.1 ([3.11.0](../change/изменения_в_версии_3.11.0.md))                                                                                                                                                                                                                                                    |
...
| `mr`       |                                   | не подменять файловую систему /run, запускаемая программа будет иметь доступ к каталогу /run хост-системы ([3.11.0](../change/изменения_в_версии_3.11.0.md))                                                                                                                                                                                                                                                              |
