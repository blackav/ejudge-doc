...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[Турниры
с токенами](Турниры_с_токенами "wikilink")
...
системе ejudge это - турниры типа [ACM](ACM "wikilink") или
[KIROV](KIROV "wikilink"), но не типа [OLYMPIAD](OLYMPIAD "wikilink")).
...
[3.2.0](Изменения_в_версии_3.2.0 "wikilink"). Рассмотрим пример
...
[`long_name`](serve.cfg:problem:long_name "wikilink")` = "Задача A"`  
[`full_score`](serve.cfg:problem:full_score "wikilink")` = 100     # полное решение - 100 баллов`  
[`full_user_score`](serve.cfg:problem:full_user_score "wikilink")` =  0 # решение на предварительных тестах получает 0 баллов`  
[`test_score`](serve.cfg:problem:test_score "wikilink")` = 5       # по 5 баллов на основные тесты`  
[`test_score_list`](serve.cfg:problem:test_score_list "wikilink")` = "0 0" # предварительные тесты стоят 0 баллов`  
[`open_tests`](serve.cfg:problem:open_tests "wikilink")` = "1-2:full,3-22:hidden" # во время турнира показывать только первые два теста`  
[`final_open_tests`](serve.cfg:problem:final_open_tests "wikilink")` = "1-22:full" # после окончания показывать все`  
...
[`tokens`](serve.cfg:problem:tokens "wikilink")` = "5+1/1h-1/FinalScore,TokenOpenTests"`
...
[`token_open_tests`](serve.cfg:problem:token_open_tests "wikilink")` = "1-22:brief"`
...
[`open_tests`](serve.cfg:problem:open_tests "wikilink")` = "1-2:full,3-22:hidden" # во время турнира показывать только первые два теста`  
[`final_open_tests`](serve.cfg:problem:final_open_tests "wikilink")` = "1-22:full" # после окончания показывать все`  
[`enable_tokens`](serve.cfg:problem:enable_tokens "wikilink")` # включить поддержку токенов для этой задачи`  
[`tokens`](serve.cfg:problem:tokens "wikilink")` = "5+1/1h-1/FinalScore,TokenOpenTests"`  
[`token_open_tests`](serve.cfg:problem:token_open_tests "wikilink")` = "1-22:brief"`  
