...
Навигация: [Система ejudge](система_ejudge.md)/[Использование](использование.md)/[Аутентификация с помощью OAUTH2](аутентификация_с_помощью_OAUTH2.md)
...
## Регистрация у провайдера аутентификации
