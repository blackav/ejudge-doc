...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[Интеграция
с github/gitlab](Интеграция_с_github/gitlab "wikilink")/[Настройка
интеграции с gitlab для
пользователя](Настройка_интеграции_с_gitlab_для_пользователя "wikilink")
