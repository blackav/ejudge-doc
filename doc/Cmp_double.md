...
программы](Стандартные_проверяющие_программы "wikilink")/[cmp_double](cmp_double "wikilink")
...
файлом](текстовый_файл "wikilink"). Вещественное число должно быть
единственным [элементом ввода](элемент_ввода "wikilink") в файле, то
