...
параметры
задач](serve.cfg:problem "wikilink")/[`final_open_tests`](Serve.cfg:problem:final_open_tests "wikilink")
...
[open_tests](Serve.cfg:problem:open_tests "wikilink")</tt>, а в режиме
