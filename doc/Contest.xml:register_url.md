...
файлы](Конфигурационные_файлы.md)/[contest.xml](contest.xml.md)/[register_url](contest.xml:register_url.md)
...
[`register`](register.md) для дальнейшей регистрации в системе
...
турнира [`contest.xml`](contest.xml.md) данный элемент не задан,
используется URL, заданный в элементе
[`register_url`](ejudge.xml:register_url.md) конфигурационного
файла [`ejudge.xml`](ejudge.xml.md). Если и тот элемент не
