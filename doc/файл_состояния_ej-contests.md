...
Навигация: [Система ejudge](система_ejudge.md)/[Использование](использование.md)/[Файл состояния ej-contests](файл_состояния_ej-contests.md)

Поддерживается с версии [3.10.1](change/изменения_в_версии_3.10.1.md).

Компонент [ej-contests](tool/ej-contests.md) экспортирует некоторые
