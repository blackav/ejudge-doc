...
Команда rejudge-all запускает перетестирование всех посылок. Данную
команду может выполнять только администратор турнира.

Использование:

`ejudge-contests-cmd CONTEST-ID rejudge-all [OPTIONS] SESSION-FILE`
