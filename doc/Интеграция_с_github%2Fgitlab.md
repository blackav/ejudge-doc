...
с github/gitlab](Интеграция_с_github/gitlab "wikilink")
...
[`enable_vcs`](serve.cfg:problem:enable_vcs "wikilink"). Например,
...
занимается компонент [ej-jobs](ej-jobs "wikilink"). Подготовленная
...
[ej-jobs](ej-jobs "wikilink"). Клонирование выполняется командой
...
задачи [`post_pull_cmd`](serve.cfg:problem:post_pull_cmd "wikilink").
...
[ej-compile](ej-compile "wikilink") по-особенному.
...
[`vcs_compile_cmd`](serve.cfg:problem:vcs_compile_cmd "wikilink"). Если
