...
программы](Проверяющие_программы "wikilink")/[libchecker](libchecker "wikilink")/[Компиляция
проверяющих
...
[`ejudge-config`](ejudge-config "wikilink"), передавая ей опции
`--cflags, --ldflags, --libs`.
...
[`serve-control`](serve-control "wikilink"), то все проверяющие
