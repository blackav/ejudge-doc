...
Навигация: [Система ejudge](система_ejudge.md)/[Использование](использование.md)/[Оценивающие программы](оценивающие_программы.md)/[gvaluer](gvaluer.md)
...
определения задачи должен содержать следующее определение параметра
...
рекомендуется использовать стандартную программу с помощью
параметра [`standard_valuer`](serve.cfg/problem/standard_valuer.md)
