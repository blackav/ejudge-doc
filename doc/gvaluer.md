...
С версии [3.13.0](change/изменения_в_версии_3.13.0.md) и выше нет
...
С версии [3.13.0](change/изменения_в_версии_3.13.0.md) и выше
...
`global_definition : "global" "{" { global_option } "}" ;  /* определяет настройки для всех групп тестов (с `[`3.6.1`](change/изменения_в_версии_3.6.1.md)`) */`  
`global_option :`  
...
`  | "sets_marked" ";"                                     /* установить флаг marked, если группа прошла (с `[`2.3.27`](change/изменения_в_версии_2.3.27.md)`) */`  
`  | "skip" ";"                                            /* безусловно пропустить данную группу тестов (с `[`2.3.27`](change/изменения_в_версии_2.3.27.md)`) */`  
`  | "sets_marked_if_passed" GROUP_ID { "," GROUP_ID } ";" /* установить флаг marked, если прошли указанные группы тестов (с `[`2.3.28`](change/изменения_в_версии_2.3.28.md)`) */`  
`  | "pass_if_count" NUM ";"                               /* считать группу тестов прошедшей, если в ней прошло NUM тестов (с `[`2.3.28`](change/изменения_в_версии_2.3.28.md)`) */`  
`  | "skip_if_not_rejudge" ";"                             /* пропустить группу тестов, если это не повторное тестирование посылки (REJUDGE) (с `[`3.0`](change/изменения_в_версии_3.0.md)`) */`  
`  | "stat_to_judges" ";"                                  /* вывести статистику о прохождении данной группы в файл комментариев для судей (с `[`3.3.0`](change/изменения_в_версии_3.3.0.md)`) */`  
`  | "stat_to_users" ";"                                   /* вывести статистику о прохождении данной группы в файл комментариев для участников турнира (с `[`3.6.1`](change/изменения_в_версии_3.6.1.md)`) */`  
`  | "user_status" STATUS ";"                              /* установить пользовательский статус тестирования в указанный, если прошла данная группа тестов (с `[`3.3.0`](change/изменения_в_версии_3.3.0.md)`) */`  
`  | "test_all" ";"                                        /* тестировать на всех тестах даже группы с групповой оценкой (с `[`3.3.0`](change/изменения_в_версии_3.3.0.md)`) */`  
`  | "0_if" TEST { "," TEST } ";"                          /* оценить группу в 0 баллов, если прошли только указанные тесты (с `[`3.6.0`](change/изменения_в_версии_3.6.0.md)`) */`  
`  | "0_if_subset" TEST { "," TEST } ";"                   /* оценить группу в 0 баллов, если прошли только тесты из указанного множества тестов (с `[`3.10.2`](change/изменения_в_версии_3.10.2.md)`) */`  
`  ;`
