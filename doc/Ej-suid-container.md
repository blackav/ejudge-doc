...
архитектура
системы](Общая_архитектура_системы "wikilink")/[ej-suid-container](ej-suid-container "wikilink")
...
| `ml`       |                                   | в изолированном пространстве сетевых интерфейсов поднять интерфейс lo (loopback) и настроить его на адрес 127.0.0.1 ([3.11.0](Изменения_в_версии_3.11.0 "wikilink"))                                                                                                                                                                                                                                                    |
...
| `mr`       |                                   | не подменять файловую систему /run, запускаемая программа будет иметь доступ к каталогу /run хост-системы ([3.11.0](Изменения_в_версии_3.11.0 "wikilink"))                                                                                                                                                                                                                                                              |
