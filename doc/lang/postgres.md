...
Навигация: [Главная страница](../main_Page.md)/[Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Поддерживаемые языки программирования](../поддерживаемые_языки_программирования.md)/[PostgresQL](postgres.md)
...
базе данных Postgres. Поддерживается как
[запуск на пользовательских данных](../запуск_на_пользовательских_данных.md), так и запуск на
наборе тестов.
