...
HTML для турниров](Шаблоны_HTML_для_турниров "wikilink")
...
[ej-page-gen](ej-page-gen "wikilink"), которая генерирует код на языке
...
конфигурационном файле турнира [contest.xml](contest.xml "wikilink") у
элемента contest нужно установить атрибут
[contest.xml:enable_local_pages](contest.xml:enable_local_pages "wikilink")
