...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[Нотификации
во внешние системы](Нотификации_во_внешние_системы "wikilink")

Поддерживается с версии [3.11.0](Изменения_в_версии_3.11.0 "wikilink").
...
[API:priv:submit-run](API:priv:submit-run "wikilink") или
[API:priv:submit-run-input](API:priv:submit-run-input "wikilink")
...
[API:priv:submit-run](API:priv:submit-run "wikilink") с указанием
...
После отправки посылки на проверку с помощью
[API:priv:submit-run-input](API:priv:submit-run-input "wikilink") с
