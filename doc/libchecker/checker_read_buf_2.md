...
файла как
текста](Libchecker:Чтение_файла_как_текста.md)/[checker_read_buf_2](Libchecker:checker_read_buf_2.md)
...
[текстового файла](текстовый_файл.md), задаваемого своим
[индексом](libchecker:file_index.md) `ind` в память. Пробельные
