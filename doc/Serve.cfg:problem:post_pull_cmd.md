...
параметры
задач](serve.cfg:problem "wikilink")/[`post_pull_cmd`](serve.cfg:problem:post_pull_cmd "wikilink")
...
Скрипт запускается компонентом [ej-jobs](ej-jobs "wikilink") с теми же
самыми правами, с которыми работает [ej-jobs](ej-jobs "wikilink").
