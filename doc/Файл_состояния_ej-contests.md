...
ejudge](Система_ejudge "wikilink")/[Использование](Использование "wikilink")/[Файл
состояния ej-contests](Файл_состояния_ej-contests "wikilink")

Поддерживается с версии [3.10.1](Изменения_в_версии_3.10.1 "wikilink").

Компонент [ej-contests](ej-contests "wikilink") экспортирует некоторые
