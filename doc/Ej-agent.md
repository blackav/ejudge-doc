...
архитектура
системы](Общая_архитектура_системы "wikilink")/[ej-agent](ej-agent "wikilink")
...
сети](Параллельное_тестирование "wikilink").
...
Компоненты компиляции [ej-compile](ej-compile "wikilink") и тестирования
[ej-super-run](ej-super-run "wikilink") выполняют команду
