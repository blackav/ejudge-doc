Навигация: [Главная страница](../main_Page.md)/[Система ejudge](../система_ejudge.md)/[Использование](../использование.md)/[Виды задач](../виды_задач.md)/[Задача на написание тестов](tests.md)
...
Участник сдает набор тестов в виде архива [определенной структуры](../структура_архива_с_тестами.md). Тестирование
предоставленных тестов выполняется в несколько этапов.

[Подготовка задачи на написание тестов](../подготовка_задачи_tests.md)

### Проверка архива на корректность

Проверка архива на корректность выполняется с помощью [программы проверки стиля](../style_checkers.md) на этапе "компиляции"
...
программу [style_archive](../style_archive.md).
...
[`binary_input`](../serve.cfg/problem/binary_input.md) секции
определения задачи.

### Проверка тестовых файлов

Проверка тестовых файлов выполняется с помощью [программы проверки тестов](../test_checkers.md). Программе проверки тестов передается
...
некорректными, выдается [ошибка неправильного формата результата](../ошибка_неправильного_формата_результата.md), и
